...
import shopping_cart from "../public/images/logos/shopping_cart.svg";
import truck from "../public/images/background/truck-solid.svg";

export const logos = [house, shopping_cart, logo1, logo2, logo6, plus];
export const videos = [
  "",
  "ecommerce",
  "theogony-api",
...
export const skills = [
  ["", "", "", "", ""],
  ["typescript", "react", "java", "mysql", "springboot"],
